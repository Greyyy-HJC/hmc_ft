...
hmc = HMC_U1_FT(lattice_size, beta, n_thermalization_steps, n_steps, ft_step_size, field_transformation=field_transformation, compute_jac_logdet=compute_jac_logdet, device=device, if_tune_step_size=True) # todo
