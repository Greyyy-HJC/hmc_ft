...
#PBS -o /lcrc/project/L-parton/jinchen/hmc_ft/2d_u1_cluster/logs/gen_L64_b1.log
...
# run conf_gen.py
python conf_gen.py --lattice_size 64 --beta 1 --n_thermalization 600 --store_interval 10 --n_configs 4096
