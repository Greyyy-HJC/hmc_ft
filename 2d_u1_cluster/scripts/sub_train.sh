...
# run train.py
python train_opt.py --lattice_size 64 --min_beta 2.0 --max_beta 6.0 --beta_gap 0.5 --n_epochs 16 --batch_size 32 --n_subsets 8 --n_workers 0 --rand_seed 2008 --if_identity_init
