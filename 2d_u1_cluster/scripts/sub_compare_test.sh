...
#PBS -o /eagle/fthmc/run/hmc_ft/2d_u1_cluster/logs/compare_hmc_L64_beta8.log
...
# run
python compare_hmc.py --lattice_size 64 --n_configs 10240 --beta 8 --step_size 0.06 --max_lag 200 --rand_seed 2008 --device 'cuda'
